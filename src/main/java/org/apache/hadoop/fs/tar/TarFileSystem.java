...
/**
 * Creates a FileSystem out of a TAR file.
 * A tar file is treated as a directory containing files.
 * Sub-directories are not yet supported.
 * Tar files can be specified using following sample URI schema <br/>
 * 
 * tar://hdfs-namenode:port/tarfile.tar (the whole tar.. treated as a directory)<br/>
 * tar://hdfs-namenode:port/tarfile.tar+somefile.txt
 * <br/>
 * <ul>
...
public class TarFileSystem extends FileSystem {
	...
	private void readHeaderBuffer(InputStream is, byte[] buffer) throws IOException {
